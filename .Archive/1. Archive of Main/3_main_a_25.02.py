...
class Connection:
    ...
    def accelX_notification_handler(self, sender: str, data: Any):
        ...
        for i in range(10, 100): # modified 25.02
            with open(f'kll_probes/{i}_probe/accelx_data.txt', "a") as f: # вставлено; modified 25.02
    ...
    def gyroX_notification_handler(self, sender: str, data: Any):
        ...
        for i in range(10, 100):  # modified 25.02
            with open(f'kll_probes/{i}_probe/gyrox_data.txt', "a") as f: # вставлено; modified 25.02
                f.write(data.decode("utf-8") + "\n") # вставлено
            self.clear_lists()
    def accelY_notification_handler(self, sender: str, data: Any):
        ...
        # print(data.decode("utf-8") + "\n")
        for i in range(10, 100):  # modified 25.02
            with open(f'kll_probes/{i}_probe/accely_data.txt', "a") as f: # вставлено; modified 25.02
                f.write(data.decode("utf-8") + "\n") # вставлено
            self.clear_lists()
    ...
    def gyroY_notification_handler(self, sender: str, data: Any):
        ...
        # print(data.decode("utf-8") + "\n")
        for i in range(10, 100):  # modified 25.02
            with open(f'kll_probes/{i}_probe/gyroy_data.txt', "a") as f: # вставлено; modified 25.02
                f.write(data.decode("utf-8") + "\n") # вставлено
            self.clear_lists()
    def accelZ_notification_handler(self, sender: str, data: Any):
        ...
        # print(data.decode("utf-8") + "\n")
        for i in range(10, 100):  # modified 25.02
            with open(f'kll_probes/{i}_probe/accelz_data.txt', "a") as f: # вставлено; modified 25.02
                f.write(data.decode("utf-8") + "\n") # вставлено
            self.clear_lists()
    ...
    def gyroZ_notification_handler(self, sender: str, data: Any):
        ...
        # print(data.decode("utf-8") + "\n")
        for i in range(10, 100):  # modified 25.02
            with open(f'kll_probes/{i}_probe/gyroz_data.txt', "a") as f: # вставлено; modified 25.02
                f.write(data.decode("utf-8") + "\n") # вставлено
            self.clear_lists()
