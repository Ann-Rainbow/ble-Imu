...
from to_csv_ann import collectCSVData     # каждая запись/измерение в отдельный csv файл
from to_csv_ann import writeCSVData       # каждая запись/измерение в отдельный csv файл
